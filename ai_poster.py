...
PROMPTS_CONFIG = {
    # 1. منشورات العملات الأكثر صعوداً (High/Gainer Coins in Futures)
    "gainers": """
...
""",
    ...
    # 2. منشورات العملات الأكثر هبوطاً ونزيفاً (Loser Coins in Futures)
    "losers": """
...
أضف إحصائيات تقريبية واقعية لحجم تصفيات اللونج بالمليون دولار (مثال: تصفية أكثر من 100 مليون دولار لونج)، وحذر الناس من التقاط السكين الساقط أو الانخداع بالارتدادات الوهمية والمصائد الصعودية المؤقتة قبل ما السوق يستقر.
اكتب بالعامية الدارجة وبشكل تغريدة تويتر قصيرة وعفوية جداً، وممنوع استخدام "أنا".
هام جداً: اجعل المنشور قصيراً ومختصراً للغاية (سطرين كحد أقصى).
""",

    # 3. منشورات الأخبار الأمنية والاختراقات وثغرات العقود (News - Security & Hacks)
    "news_security": """
...
""",
    ...
    # 4. منشورات أخبار القوانين والقضايا الحكومية والـ SEC (News - Regulation & Courts)
    "news_regulation": """
...
""",
    ...
    # 5. منشورات دخول المؤسسات والحيتان وصناديق الاستثمار (News - Institution, Whale & ETFs)
    "news_adoption": """
...
""",
    ...
    # 6. منشورات التحديثات والترقيات الفنية والتوكنومكس للعملات (News - Technology & Upgrades)
    "news_tech": """
...
""",
    ...
    # 7. منشورات الأخبار العامة لسوق الكريبتو (News - General Cryptocurrencies)
    "news_general": """
الخبر التالي هو خبر عام عن الكريبتو:
{news_text}

علق بلهجة عامية محلية وجريئة على الخبر ده وأثره على حركة صفقات العقود الآجلة وتصفية المحافظ في العملات البديلة.
قول رأيك بصراحة، هل الخبر ده مجرد تلاعب وتخويف (FUD) لتسييل الناس ولا له تأثير حقيقي؟
اكتب بشكل تغريدة تويتر قصيرة جداً وعفوية، وممنوع تماماً استخدام ضمير المتكلم "أنا" أو "تجربتي".
هام جداً: اجعل المنشور قصيراً ومختصراً للغاية (سطرين كحد أقصى).
""",

    # 8. منشورات النصائح وعلم نفس المتداولين (Trading Psychology & Tips)
    "tips": """
...
""",
    ...
    # 9. منشورات العملات الأكثر بحثاً ورواجاً حالياً (Alpha / Trending Coins)
    "alpha": """
...
""",
    ...
    # 10. منشور ملخص الأخبار الدوري كل 4 ساعات (Digest)
    "digest": """
...
المطلب منك بدقة:
1. لخص الأخبار في 2 إلى 3 نقاط قصيرة جداً ومباشرة وبدون تفاصيل مملة.
